...
if (isset($_GET['id'])) {
    ...
    // 3. Ambil data barang yang lama berdasarkan ID tersebut
...
// 4. Proses Update ketika Form di-Submit
    ...
    <div class="col-md-6">
      <div class="card shadow">
        <div class="card-header bg-primary text-white">
          <h5 class="mb-0">Form Edit Barang (Kode: <?= htmlspecialchars($data['kode_barang']); ?>)</h5>
        </div>
        <div class="card-body">
          <form action="" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="nama_barang" class="form-value form-control" value="<?= htmlspecialchars($data['nama_barang']); ?>" required>
            </div>
